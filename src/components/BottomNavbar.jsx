...
const BottomNavbar = () => {
  ...
  return (
    <nav className="bg-zinc-200 dark:bg-zinc-800 h-[55px] fixed bottom-0 left-0 w-full z-50 text-black py-8 shadow-[0px_1px_3px_3px_rgb(165,165,165)] dark:shadow-[0px_0px_10px_1px_rgba(1,1,1,.75)]">
